...
import { ElementRef, Directive, Inject, HostBinding, Input, EventEmitter, Renderer2, Component, ChangeDetectionStrategy, ViewChild, ContentChildren, Output, HostListener } from '@angular/core';
...
class DragScrollItemDirective {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.0.0", type: DragScrollItemDirective, isStandalone: true, selector: "[drag-scroll-item]", inputs: { dragDisabled: ["drag-disabled", "dragDisabled"] }, host: { properties: { "style.display": "this.display" } }, ngImport: i0 }); }
}
...
export { DragScrollComponent, DragScrollItemDirective };
